...
import RemoveAdvisorData from './component/removeadvdata';
import AdminDrawer from './component/adminDrawer';


export default function RemoveAdvisor({ data }) {
  ...
  return (
    <>
      <AdminDrawer title="Remove Advisor" />
      <div className="text-center bg-gray-200 min-h-screen">
      <div className="pt-40 sm:ml-10">
        <h1 className="text-2xl font-bold mb-4">Find advisor(by id) to remove</h1>
