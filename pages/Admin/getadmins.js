...
export default function GetAdmins({ data }) {
  ...
  return (
    <>
  <AdminDrawer title="Get Admins" />
<center>
  <div className="relative bg-blue-100 min-h-screen">
    <div className="mt-20">
      <h1 className="text-3xl font-bold mb-4">All Admins</h1>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 truncate dark:text-black">
                  <b>
                    <Link href={`/Admin/admins/${item.id}`} className="text-blue-500 hover:text-blue-700">
                      {item.name}
                    </Link>
                  </b>
                </p>
